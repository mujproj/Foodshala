...
<body>
    ...
    <!-- Add Item Login Form Starts Here -->
    <div class="container">
        <div class="loginsystem-content">
            <div class="card" id="foodform">
                <div class="card-body">
                    <div class="card-title text-center"><h5 style="color: green;">Add Menu Item</h5></div>
                    <form action="" method="POST" name="addItemForm" onsubmit="return validation()">
                        <div class="form-group">
                            <label for="itemName">Item Name</label>
                            <input type="text" id="itemName" class="form-control" placeholder="Enter Item" name="itemName">
                        </div>
                        <div class="form-group">
                            <label for="rname">Restaurant Name</label>
                            <input type="text" id="rname" class="form-control" placeholder="" name="rname" value="<?php echo $rName; ?>" disabled>
                        </div>
                        <div class="form-group">
    ...
    <script src="<?php echo base_url(); ?>js/additemvalidation.js"></script>
</body>
</html>