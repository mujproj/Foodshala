...
<body>
    ...
    <div class="bhome">
        <div class="container">
            ...
            <br>
            <div class="text-center centretext" style="font-size:20px; border: 2px solid green; border-left:50%; border-right:50%;">
                <div>FoodShala</div>
                <div>A user friendly portal</div>
                <div>Restaurant can add their items</div>
                <div>Customers can view the items and place an order</div>
                <div>Restaurant can view the orders placed by Customer</div>
                <div>Customers can view their order status</div>
            </div>
        </div>
    </div>
